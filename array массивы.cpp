...
Оказывается во многих компиляторах можно делать массив длины определяемой на этапе выполнения!
Это не включено в стандарт, но компиляторы могут. А в Си - включено с С99
